...
# classifier = nn.classifier_i3d(feature_map_input, roi_input, 1, nb_classes=len(classes_count), trainable=True)
print len(classes_count)
# bp()
classifier = nn.classifier_i3d_concat(feature_map_input, 1, nb_classes=num_classes)
